                ...
                <View>
                    <View style={styles.profile}>
                        ...
                        <Text style={styles.profileText}>{name}</Text>
                            ...
                            <TouchableHighlight onPress={() => navigation.navigate('Editname')}>
                    ...
                    <View style={styles.profile}>
                        ...
                        <TouchableHighlight onPress={() => navigation.navigate('Editmobile')}>
                            <View style={styles.editvw}>
                                <Icon name='edit' size={20} color='#939696' />
                            </View>
                            </TouchableHighlight>
                    ...
                    <View style={styles.profile}>
                        ...
                        <TouchableHighlight onPress={() => navigation.navigate('Editemail',)}>
                            <View style={styles.editvw}>
                                <Icon name='edit' size={20} color='#939696' />
                            </View>
                            </TouchableHighlight>

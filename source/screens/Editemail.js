    ...
    return (
        ...
        <View>
                        <View style={styles.inputvw}>
                            ...
                            <TextInput style={styles.inputtext} onChangeText={text => setEmail(text)} value={email} placeholder='Mail' placeholderTextColor='#939696' />

                        </View>
                        <View style={styles.btview}>
                            <View style={styles.btn}><Button title='Cancel' onPress={() => navigation.navigate('Home')} /></View>
                            <View style={styles.btn}><Button title='Edit' onPress={() => editemail()} /></View>
